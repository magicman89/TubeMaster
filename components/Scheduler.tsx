            ...
            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-end mb-8 gap-6 pb-6 border-b border-white/5">
                ...
                <div className="flex flex-wrap items-center gap-4">
                    ...
                    <div className="flex items-center glass-panel rounded-xl p-1">
                        ...
                        <select
                            value={filterStatus}
                            onChange={(e) => setFilterStatus(e.target.value as 'all' | 'concept' | 'production' | 'ready')}
                    ...
                    <button
                        ...
                        className={`px-4 py-3 rounded-xl text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-2 border ${autoFillEnabled
                                ...
                                {!editingId && (
                                    <div className="flex-1">
                                        ...
                                        <div className="relative">
                                            <select
                                                value={formRepeat}
                                                onChange={(e) => setFormRepeat(e.target.value as 'none' | 'weekly' | 'daily')}
